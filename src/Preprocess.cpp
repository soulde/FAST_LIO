...
Preprocess::Preprocess()
        : feature_enabled(0), lidar_type(MID360), blind(0.01), point_filter_num(1) {
    inf_bound = 10;
    N_SCANS = 6;
    SCAN_RATE = 10;
    group_size = 8;
...
void Preprocess::mid360_handler(const livox_ros_driver2::msg::CustomMsg::ConstPtr &msg) {
    pl_surf.clear();
    pl_corn.clear();
    pl_full.clear();
...
int Preprocess::plane_judge(const PointCloudXYZI &pl, std::vector<orgtype> &types, uint i_cur, uint &i_nex,
